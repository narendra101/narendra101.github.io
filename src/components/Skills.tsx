...
import { AISkillsGlowCard } from "./skills/AISkillsGlowCard";

const skillCategories = [
  {
    title: "GenAI & Tech",
    skills: ["Generative AI", "LLM", "LLM Agents", "OpenAI", "Anthropic", "Agno Agents", "Prompt Engineering", "Cursor", "Claude Code", "Python Web Scrapping"]
  },
  {
...
export const Skills = () => {
  return (
    <section id="skills" className="py-32 px-6 bg-[#0a0a0a] overflow-x-hidden">
      <div className="max-w-7xl mx-auto w-full min-w-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 w-full min-w-0">
